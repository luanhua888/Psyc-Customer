...
export default function Home(props) {
  ...
  return (
    <>
        ...
        <div className="md:container mx-auto py-5">
          <div className="flex justify-around">
            <div className="flex flex-col gap-3 justify-center items-center bg-white py-5 px-24 rounded-xl min-w-[200px] max-w-[250px]">
              ...
              <a className=" w-max h-max" href="#">Trực tiếp</a>
            </div>
            <div className="flex flex-col gap-3 justify-center items-center bg-white py-5 px-24 rounded-xl min-w-[200px] max-w-[250px]">
              <Image src={astroRoundedImg} alt="" width={65} height={65} />
              <a className=" w-max h-max" href="#">Dịch vụ</a>
            </div>
            <div className="flex flex-col gap-3 justify-center items-center bg-white py-5 px-24 rounded-xl min-w-[200px] max-w-[250px]">
              <Image src={astroRoundedImg} alt="" width={65} height={65} />
              <a className=" w-max h-max" href="#">Tương thích cặp đôi</a>
            </div>
            <div className="flex flex-col gap-3 justify-center items-center bg-white py-5 px-24 rounded-xl min-w-[200px] max-w-[250px]">
              <Image src={astroRoundedImg} alt="" width={65} height={65} />
              <a className=" w-max h-max" href="#">Bản đồ sao</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="md:container mx-auto py-8">
          ...
          <div className="flex justify-evenly ">
            {articles.map((row, key) => (
              ...
              <div  key={key}  className="flex flex-col gap-2 justify-center items-center bg-white py-1 px-1 rounded-xl min-w-[294px] max-w-[356px] shadow-md shadow-indigo-300">
                <Image
      ...
      <section id="#trust_score" className="bg-gradient-to-b from-indigo-300 to-slate-800">
