...
export default function deposit () {
  return (
    <>
        <div class="flex flex-col justify-center items-center bg-gray-100 mr-70 ml-70 mt-20 mb-20 pb-40">
            <div class="flex flex-col justify-center items-center bg-white w-1/2 rounded-xl shadow-lg m-2 p-2">
