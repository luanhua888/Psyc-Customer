...
export default function Payment() {
  ...
  const handleOpen = () => {
    ...
    if (amount >= 50 && amount <= 20000 && amount % 1 == 0) {
    ...
    if (amount % 1 != 0) {
      setErrorMessages({
        isError: true,
        message: "Số tiền nạp phải là số nguyên",
      });
    }
  };
                  ...
                  <Tabs.Item active={true} title="MOMO" text="black">
                    <div class="flex flex-col relative">
                      ...
                      "
                        ...
                        {/* <div class="m-10"></div> */}
                        <div
                          className=" text-black justify-center items-center flex flex-rowVND(k)
